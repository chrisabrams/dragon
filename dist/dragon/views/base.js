...
var DragonBaseView = function () {
  function DragonBaseView() {
    ...
    (0, _classCallCheck3.default)(this, DragonBaseView);
  ...
  (0, _createClass3.default)(DragonBaseView, [{
    key: 'addedToDOM',
...
(0, _assign2.default)(DragonBaseView.prototype, { mixin: _mixin2.default });
...
*/
DragonBaseView.prototype.directOptions = ['attachOnInit', 'attachPlacement', 'bindDataOnInit', 'class', // why did CSS use this?
