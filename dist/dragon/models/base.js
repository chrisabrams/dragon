...
var DragonBaseModel = function () {
  function DragonBaseModel() {
    ...
    (0, _classCallCheck3.default)(this, DragonBaseModel);
  ...
  */
  ...
  (0, _createClass3.default)(DragonBaseModel, [{
    key: 'clear',
    ...
    */
    ...
    key: 'unobserveAttributes',
    value: function unobserveAttributes() {
      //delete this.attr
...
(0, _assign2.default)(DragonBaseModel.prototype, { mixin: _mixin2.default });
